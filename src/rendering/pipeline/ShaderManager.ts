...
export class ShaderManager {
    ...
    private async loadBuiltinShaders(): Promise<void> {
        ...
        const lightingShaderSource = await this.loadShaderSource('/src/rendering/shaders/lighting.wgsl');
    ...
    private setupIncludeResolver(): void {
        ...
        this.includeResolver.set('common.wgsl', `
        ...
        this.includeResolver.set('atmosphere.wgsl', `
